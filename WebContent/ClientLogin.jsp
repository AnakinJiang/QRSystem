...
<title>商家登录页面</title>
<!-- Client Theme files -->
<link href="Client/css/ClientLoginStyle.css" rel="stylesheet" type="text/css" media="all"/>
<!-- Client Theme files -->
...
<div class="login">
	...
	<div class="login-top">
		...
		<form  action="ClientLogin" method="post">
			<input type="text"  name="client.ID" placeholder="User Id">
			<input type="password"   name="client.password" placeholder="Password">
	    <div class="forgot">
	    	<input type="submit" value="登录" >
	    </div>
	    </form>
	</div>
	<div class="login-bottom-Client">
		<h3>没有账号？&nbsp;<a href="ClientRegisterHome.jsp">点此注册</a></h3>
	</div>
</div>	
<div class="copyright">
